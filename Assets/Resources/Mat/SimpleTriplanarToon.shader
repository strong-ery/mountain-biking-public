Shader "MilklessCereal/URP/Simple Triplanar Toon"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(Varyings input) : SV_Target
            {
                ...
                // Sample base map using triplanar projection and multiply with base color
                float4 baseTexture = SampleTriplanar(TEXTURE2D_ARGS(_BaseMap, sampler_BaseMap), input.positionWS, normalWS, _Tiling, _TriplanarBlendSharpness);
                ...
                float3 finalNormal = SampleTriplanarNormal(TEXTURE2D_ARGS(_NormalMap, sampler_NormalMap), input.positionWS, normalWS, tangentX, tangentY, tangentZ, _Tiling, _TriplanarBlendSharpness, _NormalScale);
                ...
                finalColor += ApplyToonShadingToLight(mainLight, finalNormal, viewDirWS, baseColor.rgb);
                ...
                half3 additionalLightColor = 0.0h;
                    ...
                    uint pixelLightCount = GetAdditionalLightsCount();
                        ...
                        for (uint lightIndex = 0; lightIndex < min(URP_FP_DIRECTIONAL_LIGHTS_COUNT, MAX_VISIBLE_LIGHTS); ++lightIndex) 
                        {
                            ...
                            additionalLightColor += ApplyToonShadingToLight(light, finalNormal, viewDirWS, baseColor.rgb);
                        }
                    #endif
    ...
    CustomEditor "MilklessCereal.Editor.SimpleTriplanarToonShaderGUI"
}