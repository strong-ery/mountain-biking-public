...
public class KnockedOutFaceAnimator : MonoBehaviour
{
    ...
    private IEnumerator PerformBlink()
    {
        ...
        yield return StartCoroutine(AnimateEyelids(9f, 10f, blinkSpeed * 0.5f));
        yield return StartCoroutine(AnimateEyelids(10f, 9f, blinkSpeed * 0.5f));
